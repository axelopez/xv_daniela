...
class ConfirmationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create confirmation" do
    assert_difference("Confirmation.count") do
      post confirmations_url, params: { confirmation: { comment: @confirmation.comment, name: @confirmation.name, phone: @confirmation.phone } }
    end
  ...
  test "should update confirmation" do
    patch confirmation_url(@confirmation), params: { confirmation: { comment: @confirmation.comment, name: @confirmation.name, phone: @confirmation.phone } }
